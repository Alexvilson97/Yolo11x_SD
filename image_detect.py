...
if __name__ == "__main__":
    folder_path = r"Images\Rain_scenario\RD"  # Folder containing multiple images
    ground_truth_csv_folder = r"Annotations\Rain_scenario\RD_CSV"  # Folder containing ground truth CSVs
