...
def plot_precision_recall_curve(real_precisions, real_recalls, synthetic_precisions, synthetic_recalls, confidence_thresholds):
    plt.figure(figsize=(8, 6))
    plt.plot(real_recalls, real_precisions, marker='o', label='Real Image PR Curve')
    plt.plot(synthetic_recalls, synthetic_precisions, marker='x', label='Synthetic Image PR Curve')
    plt.xlabel('Recall')
...
if __name__ == "__main__":
    ...
    plot_precision_recall_curve(precisions_real, recalls_real, precisions_synthetic, recalls_synthetic, confidence_thresholds)

    # Print all outputs: TPR, FPR, Precision, Recall
    print("Real Image Metrics:")
    print("TPR: ", tpr_real)
    print("FPR: ", fpr_real)
    print("Precision: ", precisions_real)
    print("Recall: ", recalls_real)
    
    print("\nSynthetic Image Metrics:")
    print("TPR: ", tpr_synthetic)
    print("FPR: ", fpr_synthetic)
    print("Precision: ", precisions_synthetic)
    print("Recall: ", recalls_synthetic)
